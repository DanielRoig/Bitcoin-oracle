...
class Crawler():
	def __init__(self, keyword, hours, lang):
		...
		self.auth.set_access_token("935832971390738433-PeGkE4PPapZSYjPOdXqeezH5O2lVjvf", "VwW75cuyO38sCWaJ7nfHbtmF3YHlBoJ4PSzGx903w2qxl")
			...
			try:
				...
				for tweet in new_tweets:
					...
					if time_first_tweet==0:
						...
						self.myTweets.append(Tweet(tweet.text, tweet.created_at, tweet.author.screen_name, tweet.author.id, tweet.author.followers_count))
